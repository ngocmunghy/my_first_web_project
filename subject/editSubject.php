...
$mamh = $_GET['id'];
$cmd = "select * from monhoc where mamh = '$mamh'";
      ...
      <div class="panel panel-primary">
        ...
        <div class="panel-body">
          <form method="POST">
            ...
            <div class="form-group">
              <label for="address">Credits:</label>
              <input type="number" class="form-control" id="address" name="tinchi" value="<?php echo $res['tinchi']; ?>">
            </div>
